...
class UserInfo(models.Model):
    ...
    user_name = models.CharField(
        null=False, blank=False, unique=True, max_length=128, db_column="用户名")
    password = models.CharField(
        null=False, blank=False, max_length=128, db_column="密码")
    ...
    user_tel = models.CharField(
        default='9352', null=False, blank=False, max_length=20, db_column="电话")
...
class AuthToken(models.Model):
    ...
    user_id = models.OneToOneField(
        to='UserInfo', to_field='user_id', on_delete=models.CASCADE)
